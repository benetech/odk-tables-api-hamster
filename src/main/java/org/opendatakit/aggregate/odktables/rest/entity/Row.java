...
public class Row {
  ...
  /**
   * identifies this revision of this row of data. (needed to support updates to data rows)
  ...
  /**
   * identifies the service-level interaction during which this revision was made. Useful for
   * finding coincident changes and prior/next changes.
   */
  @JsonProperty(required = false)
  ...
  /**
   * audit field returned for archive/recovery tools.
   */
  @JsonProperty(required = false)
   ...
   *
   * The ODK Survey form that was used when revising this row.
   *
   * This can be useful for implementing workflows. I.e., if savepointTyp is COMPLETE with this
   * formId, then enable editing with this other formId.
   */
  @JsonProperty(required = false)
   ...
   * OdkTables metadata column.
   *
   * The locale of the device that last revised this row.
   */
  @JsonProperty(required = false)
   ...
   * OdkTables metadata column.
   *
   * One of either COMPLETE or INCOMPLETE. COMPLETE indicates that the formId used to fill out the
   * row has validated the entered values.
   */
  @JsonProperty(required = false)
   ...
   * OdkTables metadata column.
   *
   * For Mezuri, the timestamp of this data value.
   *
   * For ODK Survey, the last save time of the survey.
   *
   * For sensor data, the timestamp for the reading in this row.
   */
  @JsonProperty(required = false)
   ...
   * OdkTables metadata column.
   *
   * For ODK Survey, the user that filled out the survey.
   *
   * Unclear what this would be for sensors.
   *
   * For Mezuri, this would be the task execution ID that created the row.
   */
  @JsonProperty(required = false)
   ...
   *
   * Implements DEFAULT, MODIFY, READ_ONLY, HIDDEN with filterValue being the "owner" of the row.
   * 
   * It is passed down to the device so that the device can do best-effort enforcement of access
   * control (trusted executor)
   */
  ...
  /**
   * Array of user-defined column name to the string representation of its value. Sorted by
  ...
  public static Row forUpdate(String rowId, String rowETag, String formId, String locale,
      ...
      RowFilterScope filterScope, ArrayList<DataKeyValue> values) {
    Row row = new Row();
    row.rowId = rowId;
    row.rowETag = rowETag;
    row.formId = formId;
  ...
  public boolean equals(Object obj) {
    ...
    boolean simpleMatch = (rowId == null ? other.rowId == null : rowId.equals(other.rowId))
        ...
        && (lastUpdateUser == null ? other.lastUpdateUser == null
            : lastUpdateUser.equals(other.lastUpdateUser))
        && (rowFilterScope == null ? other.rowFilterScope == null
            : rowFilterScope.equals(other.rowFilterScope))
        && (savepointCreator == null ? other.savepointCreator == null
        ...
        && (savepointType == null ? other.savepointType == null
            : savepointType.equals(other.savepointType))
        && (savepointTimestamp == null ? other.savepointTimestamp == null
  ...
  public boolean hasMatchingSignificantFieldValues(Row other,
      Comparator<DataKeyValue> deepComparator) {
    if (other == null)
      return false;
    boolean simpleMatch = (rowId == null ? other.rowId == null : rowId.equals(other.rowId))
        && (deleted == other.deleted)
